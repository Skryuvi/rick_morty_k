...
import 'package:rick_morty/domain/preferences_controller.dart' as _i482;
import 'package:rick_morty/provider/db/db_provider.dart' as _i198;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.singleton<_i198.DatabaseProvider>(() => _i198.DatabaseProvider());
    gh.singleton<_i482.PreferencesController>(
        () => _i482.PreferencesController());
    gh.singleton<_i648.RemoteSource>(
        () => _i648.RemoteSource(gh<_i199.NetworkProvider>()));
    gh.singleton<_i149.LocalSource>(
        () => _i149.LocalSource(gh<_i198.DatabaseProvider>()));
